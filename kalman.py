...
class ExtendedKalmanFilter:
    ...
    def update_with_position(self, measured_position: Coordinate, timestamp: float):
        ...
        # Kalman gain - use solve for better numerical stability
        try:
    ...
    def update_with_pseudoranges(
        ...
        # Pre-convert signal positions to numpy array for performance
        sat_positions = np.array([[signal.x, signal.y, signal.z] for signal in signals])
        
        # Build measurement vector, Jacobian, and predicted measurements in single pass
        ...
        for i in range(n_sats):
            # Geometric range (calculate once)
